...
const Index = () => {
    ...
    const { loginError } = useContext(MiscContext)
    ...
    return (
        <section className="bg-white {-- h-screen --}">
            <div className="mx-auto flex justify-center h-full flex-col lg:flex-row">
                <form ref={form} onSubmit={handleSubmit} autoComplete="off" className="w-full lg:w-1/2 flex justify-center bg-white dark:bg-gray-900">
                    <div className="w-full sm:w-4/6 md:w-3/6 lg:w-2/3 text-gray-800 dark:text-gray-100 mb-12 sm:mb-0 flex flex-col justify-center px-2 sm:px-0">
                        ...
                        {loginError ? (
                            ...
                            <span class="block sm:inline">  Password or Email input error</span>
                        ...
                        <div className="mt-8 w-full px-2 sm:px-6">
                            <div className="flex flex-col mt-8">
                                ...
                                <input required id="email" name="email" className={`h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 ${loginError ? 'border-red-500 border-2' : 'border-gray-300'} border shadow`} type="email" />
                            </div>
                            <div className="flex flex-col mt-5">
                                <label htmlFor="password" className="text-lg font-semibold fleading-tight">
                                    Password
                                </label>
                                <input required id="password" name="password" className={`h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 ${loginError ? 'border-red-500 border-2' : 'border-gray-300'} border shadow`} type="password" />
                            </div>
                        </div>
                ...
                <div className="w-full lg:w-1/2 bg-indigo-600 px-2 py-40 sm:py-48 sm:px-12 flex flex-col justify-center relative bg-no-repeat bg-center bg-cover h-full" style={{ backgroundImage: "url(https://cdn.tuk.dev/assets/Image.jpg)" }}>
                    ...
                    <div className="flex relative z-30 flex-col justify-center pl-4 md:pr-12 xl:pr-12 md:pl-24">
                        ...
                        <p className="text-xl text-white leading-normal pt-3 xl:w-10/12">With Instaengage, it takes just a few minutes to set up your account and engage with others in the community.</p>
                    </div>
