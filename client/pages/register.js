                ...
                <form ref={form} onSubmit={handleSubmit} autoComplete="off" className="w-full lg:w-1/2 flex justify-center bg-white dark:bg-gray-900">
                    <div className="w-full sm:w-4/6 md:w-3/6 lg:w-2/3 text-gray-800 dark:text-gray-100 mb-12 sm:mb-0 flex flex-col justify-center px-2 sm:px-0">
                        ...
                        <div className="flex flex-col mt-8">
                                <label htmlFor="user" className="text-lg font-semibold leading-tight">
                                    Full Name
                                </label>
                                <input required id="user" name="user" className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" type="text" />
                            </div>
                            <div className="flex flex-col mt-8">
